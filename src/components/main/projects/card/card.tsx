...
export default function Card (props : Card){
    return (
        <div className={css.card}>
            ...
            <a className={css.link}><img className={css.img} src='https://melmanpvp.github.io/portfolio-project//link.svg' alt=''/>Live Preview</a>
            <a className={css.link}> <img className={css.img} src='https://melmanpvp.github.io/portfolio-project//githubsmol.svg' alt=''/>View Code</a>
            </div>
